...
@implementation UIImage (XB_Extension)
...
- (UIImage *)imageWithAlpha:(CGFloat)alpha radius:(CGFloat)radius colorSaturationFactor:(CGFloat)colorSaturationFactor {
    ...
    return [self blurWithFrame:CGRectMake(0, 0, self.size.width, self.size.height) Radius:radius tintColor:tintColor saturationDeltaFactor:colorSaturationFactor maskImage:nil];
}
...
- (UIImage *)imageWithFrane:(CGRect)frame Alpha:(CGFloat)alpha radius:(CGFloat)radius colorSaturationFactor:(CGFloat)colorSaturationFactor {
    UIColor *tintColor = [UIColor colorWithWhite:1.0 alpha:alpha];
    return [self blurWithFrame:frame Radius:radius tintColor:tintColor saturationDeltaFactor:colorSaturationFactor maskImage:nil];
}

- (UIImage *)imageWithCornerRadius:(CGFloat)radius {
    CGRect rect = (CGRect){0.0, 0.0, self.size};
...
/**
 Private:图片模糊算法
 */
- (UIImage *)blurWithFrame:(CGRect)frame Radius:(CGFloat)blurRadius tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage {
